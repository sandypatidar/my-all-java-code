...
<html>
    <head>
        ...
        <title>HOTEL PAPAYA TREE, INDORE</title>
    ...
    <body> 
        ...
        <div class="container-fluid">
            <img src="hotels/papaya tree image.jpg" alt="papaya" align="middle" style="padding-bottom:25px;"/><br>
            <font color="GREEN" SIZE="100" style="text-align:center"><b>PAPAYA TREE </b></font>   <font color="YELLOW" SIZE="100" style="text-align:center"><span class="glyphicon glyphicon-star"><span class="glyphicon glyphicon-star"><span class="glyphicon glyphicon-star"></span></font> 
        </div>
        <div class="container">
       <div class="row">
...
<div class="dropdown">
    <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" >     <font <span class="glyphicon glyphicon-bell" color="white" SIZE="25" style="text-align:center">  Local Attractions</font> 
        ...
        <span class="caret" ></span></button><br></br>
            ...
            <img src="hotels/raddison logo.png" alt="lemon tree" align="middle" style="padding-bottom:25px;"/><br>
      
            
    <ul class="dropdown-menu"><p><b>“The First International School of Madhya Pradesh”</b><br>
...
Emerald Heights is affiliated to Central Board of Secondary Education (CBSE), New Delhi - An autonomous organization under the ministry of Human Resource Development, Govt. of India and Cambridge International Examination (CIE), one of the world’s leading provider of educational qualification and assessments.
...
<span class="glyphicon glyphicon-phone " style="color:green"></span><font color="green">Phone:</font> 0731 471 4747<br>
...
<span class="glyphicon glyphicon-map-marker"style="color:green"></span><font color="green">Location:</font>Rau Indore Bypass Square, Opposite Dr. Hardia Eye hospital AB Road, Rau, Indore, Madhya Pradesh 453331 <br>
                           </div>
                    </div>
                </div>
            </div>
